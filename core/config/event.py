...
class EventStyles(object):
    ...
    Predefined colors
    """
    USER1 = EventStyle(event_border=(175, 191, 115,500), event_fill=(175, 191, 115,500))
    USER2 = EventStyle(event_border=(245, 222, 131,500), event_fill=(245, 222, 131,500))
    USER3 = EventStyle(event_border=(242, 184, 75,500), event_fill=(242, 184, 75,500))
    USER4 = EventStyle(event_border=(217, 94, 50,500), event_fill=(217, 94, 50,500))
